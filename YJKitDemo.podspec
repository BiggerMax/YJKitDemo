#
#  Be sure to run `pod spec lint YJKitDemo.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/BiggerMax/YJKitDemo.git", :tag => "v#{s.version}" }
