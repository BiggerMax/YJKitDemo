...
-(id)initWithTitle:(NSString*)title view:(UIView*)view array:(NSArray*)array delegate:(id<SimplePickerViewDelegate>)delegate
{
    ...
    if (self) {
        ...
        [_cancelButton setTitleColor:[COLOR fromString:@"#3083FB"]forState:UIControlStateNormal];
        ...
        [_confirmButton setTitleColor:[COLOR fromString:@"#3083FB"]forState:UIControlStateNormal];
