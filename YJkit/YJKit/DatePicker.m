...
//        _datePicker.date = dateAndTime;
//        _datePicker.date = [NSDate date];
        [_datePicker setDate:dateAndTime animated:YES];
        ...
        [_dateCancelButton setTitleColor:[COLOR fromString:@"#3083FB"]forState:UIControlStateNormal];
        ...
        [_dateConfirmButton setTitleColor:[COLOR fromString:@"#3083FB"]forState:UIControlStateNormal];
